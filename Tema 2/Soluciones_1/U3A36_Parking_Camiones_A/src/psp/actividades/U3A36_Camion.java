...
public class U3A36_Camion implements Runnable {
    ...
    U3A36_Camion(int tiempoEsperaMin, int tiempoEsperaMax, U3A36_ControlPlazas plazasParking) {
    ...
    public void run() {
        ...
        plazasParking.entraCamion(this.matricula);
        ...
        plazasParking.saleCamion(this.matricula);
    }
